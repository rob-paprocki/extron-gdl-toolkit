...
- The Pillow compositor sits at a 2.07% median / 2.65% mean pixel difference
  across navigable pages. Two known fixes are measured but unimplemented:
  synthesising `borderFillColor` fills, and the bilevel-vs-antialiased text
  decision (worth roughly another 1% mean). See `docs/render-fidelity.md`.
